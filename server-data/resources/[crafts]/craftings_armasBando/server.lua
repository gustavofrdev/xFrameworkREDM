...
craftings_armasBando = Tunnel.getInterface("craftings_armasBando")
craftings_armasBandoSv = Proxy.getInterface("craftings_armasBando")
_Tunnel = {}
...
function _Tunnel.medPerm()
    return FrameworkSV.HasPermission(FrameworkSV.GetUserId(source), "bandido1.permissao") or FrameworkSV.HasPermission(FrameworkSV.GetUserId(source), "bandido2.permissao")
end
