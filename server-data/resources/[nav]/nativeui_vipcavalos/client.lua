...
nativeui_vipcavalos = Proxy.getInterface("nativeui_vipcavalos")
nativeui_vipcavalosSv = Tunnel.getInterface("nativeui_vipcavalos")
_Tunnel = {}
...
RegisterNUICallback('ButtonClick',function(data, cb)
        ...
        if data == 'fechar' then
            ...
            nativeui_vipcavalosSv.comprar(data)
        end
    end
)
local blip = {}
