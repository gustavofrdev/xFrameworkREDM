...
Security
Insights
redm-imaps/client.lua
@kibook
kibook Remove imap at bar above SD gun shop
Latest commit 98ec04e 9 days ago
 History
 1 contributor
3139 lines (3016 sloc)  125 KB
...
function ActivateInteriorEntitySets(interior, name, sets)
	if IsValidInterior(interior) then
		if IsInteriorEntitySetActive(interior, sets[1]) then
			--(name .. " interior already active")
		else
			for _, set in ipairs(sets) do
				ActivateInteriorEntitySet(interior, set)
			end
			--(name .. " interior activated")
		end
	end
end
