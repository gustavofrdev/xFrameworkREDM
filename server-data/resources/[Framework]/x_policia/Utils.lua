...
function spawnNewPoliceHorse(ped, position)
	if out then TriggerEvent("xFramework:Notify", "negado", "Você já possuí um cavalo do lado de fora, policials") return end;
